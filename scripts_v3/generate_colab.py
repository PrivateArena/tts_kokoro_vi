...
def main():
    ...
    notebook["cells"].append(create_code_cell([
        ...
        "",
        "# 3. Clone monotonic_align repository if missing",
        "if not os.path.exists('/content/StyleTTS2/monotonic_align'):",
        "    print('Cloning monotonic_align repository ...')",
        "    !git clone https://github.com/resemble-ai/monotonic_align.git /content/StyleTTS2/monotonic_align",
        "",
        "# 4. Create symlink at /opt/StyleTTS2 for run_train.py compatibility",
        ...
        "",
        "# 5. Compile monotonic_align in-place",
