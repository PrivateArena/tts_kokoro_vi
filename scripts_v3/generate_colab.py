...
def main():
    ...
    notebook["cells"].append(create_code_cell([
        ...
        "",
        "        # 10. Programmatically patch StyleTTS2's meldataset.py and text_utils.py to dynamically load config.json vocabulary",
        "        for target_path in ['/content/StyleTTS2/meldataset.py', '/content/StyleTTS2/text_utils.py']:",
        "            if os.path.exists(target_path):",
        "                with open(target_path, 'r', encoding='utf-8') as f:",
        "                    code = f.read()",
        "                if 'Dynamic vocabulary loading patch' not in code:",
        "                    print(f'Applying dynamic vocabulary loading patch to {target_path}...')",
        "                    target_start = code.find('_pad = \"$\"')",
        "                    if target_start == -1:",
        "                        target_start = code.find(\"_pad = '$'\")",
        "                    target_end = code.find('class TextCleaner')",
        "                    if target_start != -1 and target_end != -1:",
        "                        patch = (",
        "                            'import json\\\\n'",
        "                            'import os\\\\n\\\\n'",
        "                            '# Dynamic vocabulary loading patch for Vietnamese\\\\n'",
        "                            'vocab_path = \"/content/tts_kokoro_vi/kokoro_vietnamese/config.json\"\\\\n'",
        "                            'if not os.path.exists(vocab_path):\\\\n'",
        "                            '    vocab_path = \"/workspace/kokoro_vietnamese/config.json\"\\\\n'",
        "                            'if not os.path.exists(vocab_path):\\\\n'",
        "                            '    for p in [\"kokoro_vietnamese/config.json\", \"../kokoro_vietnamese/config.json\", \"config_vi.json\", \"config.json\"]:\\\\n'",
        "                            '        if os.path.exists(p):\\\\n'",
        "                            '            vocab_path = os.path.abspath(p)\\\\n'",
        "                            '            break\\\\n\\\\n'",
        "                            'dicts = {}\\\\n'",
        "                            'symbols = []\\\\n'",
        ...
        "                            '                symbols = [x[0] for x in sorted_vocab]\\\\n'",
        ...
        "                            '    _letters_ipa = \"ɑɐɒæɓʙβɔɕçɗɖðʤəɘɚεɜɝɞɟʄɡɠɢʛɦɧħɥHzi\\\\u026a\\\\u029d\\\\u026d\\\\u026c\\\\u026b\\\\u026e\\\\u0271\\\\u026f\\\\u0270\\\\u024d\\\\u0273\\\\u0272\\\\u0274\\\\u00f8\\\\u0275\\\\u0278\\\\u03b8\\\\u0153\\\\u0276\\\\u0298\\\\u0279\\\\u027a\\\\u027e\\\\u027b\\\\u0280\\\\u0281\\\\u027d\\\\u0282\\\\u0283\\\\u0288\\\\u02a7\\\\u0289\\\\u028a\\\\u028b\\\\u02c0\\\\u028c\\\\u0263\\\\u0264\\\\u028d\\\\u03c7\\\\u028e\\\\u028f\\\\u0291\\\\u0290\\\\u0292\\\\u0294\\\\u02a1\\\\u0295\\\\u02a2\\\\u01c0\\\\u01c1\\\\u01c2\\\\u01c3\\\\u02c8\\\\u02cc\\\\u02d0\\\\u02d1\\\\u02bc\\\\u02b4\\\\u02b0\\\\u02b1\\\\u02b2\\\\u02b7\\\\u02e0\\\\u02e4\\\\u02de\\\\u2193\\\\u2191\\\\u2192\\\\u2197\\\\u2198\\\\\\'̩\\\\\\'\u1d7b\"\\\\n'",
        "                            '    symbols = [_pad] + list(_punctuation) + list(_letters) + list(_letters_ipa)\\\\n'",
        "                            '    for i in range(len(symbols)):\\\\n'",
        "                            '        dicts[symbols[i]] = i\\\\n\\\\n'",
        "                    )",
        "                    code = code[:target_start] + patch + code[target_end:]",
        "                    code = code.replace('print(text)', 'pass')",
    ...
    notebook["cells"].append(create_code_cell([
        ...
        "        print('\\n' + '='*50)",
        "        print(f'TRAINING RUN FAILED WITH EXIT CODE: {process.returncode}')",
        "        print('='*50)",
        "        print('--- LAST 50 LINES OF ERROR LOGS ---')",
